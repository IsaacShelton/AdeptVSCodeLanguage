...
var ASM_CONSTS = {
  37112: () => { return process.platform == 'win32' ? 1 : 0 },  
 37159: () => { return process.platform == 'darwin' ? 1 : 0 },  
 37207: () => { return process.arch == 'arm64' ? 1 : 0 },  
 37248: () => { return process.arch == 'x64' ? 1 : 0 },  
 37287: () => { return process.platform == 'linux' ? 1 : 0 }
};
...
var ___start_em_js = Module['___start_em_js'] = 37334;
var ___stop_em_js = Module['___stop_em_js'] = 38346;
