...
var STACK_BASE = 5273104,
    STACKTOP = STACK_BASE,
    STACK_MAX = 30224,
    DYNAMIC_BASE = 5273104;
...
var ASM_CONSTS = {
  2676: function() {return process.platform == 'win32' ? 1 : 0},  
 2733: function() {return process.platform == 'darwin' ? 1 : 0},  
 2800: function() {return process.platform == 'linux' ? 1 : 0}
};
