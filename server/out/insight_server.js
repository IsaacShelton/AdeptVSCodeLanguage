...
var STACK_BASE = 5274288,
    STACKTOP = STACK_BASE,
    STACK_MAX = 31408,
    DYNAMIC_BASE = 5274288;
...
var ASM_CONSTS = {
  3615: function() {return process.platform == 'win32' ? 1 : 0},  
 3672: function() {return process.platform == 'darwin' ? 1 : 0},  
 3739: function() {return process.platform == 'linux' ? 1 : 0}
};
