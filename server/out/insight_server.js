...
var STACK_BASE = 5279104,
    STACKTOP = STACK_BASE,
    STACK_MAX = 36224,
    DYNAMIC_BASE = 5279104;
...
var ASM_CONSTS = {
  4736: function() {return process.platform == 'win32' ? 1 : 0},  
 4793: function() {return process.platform == 'darwin' ? 1 : 0},  
 4851: function() {return process.arch == 'arm64' ? 1 : 0},  
 4903: function() {return process.arch == 'x64' ? 1 : 0},  
 4961: function() {return process.platform == 'linux' ? 1 : 0}
};
