...
var STACK_BASE = 5274256,
    STACKTOP = STACK_BASE,
    STACK_MAX = 31376,
    DYNAMIC_BASE = 5274256;
...
var ASM_CONSTS = {
  3605: function() {return process.platform == 'win32' ? 1 : 0},  
 3662: function() {return process.platform == 'darwin' ? 1 : 0},  
 3729: function() {return process.platform == 'linux' ? 1 : 0}
};
