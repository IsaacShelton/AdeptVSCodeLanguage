...
var STACK_BASE = 5275248,
    STACKTOP = STACK_BASE,
    STACK_MAX = 32368,
    DYNAMIC_BASE = 5275248;
...
var wasmBinaryFile = 'insight_server.wasm';
...
var ASM_CONSTS = {
  3820: function() {return process.platform == 'win32' ? 1 : 0},  
 3877: function() {return process.platform == 'darwin' ? 1 : 0},  
 3935: function() {return process.arch == 'arm64' ? 1 : 0},  
 3987: function() {return process.arch == 'x64' ? 1 : 0},  
 4045: function() {return process.platform == 'linux' ? 1 : 0}
};
...
/** @type {function(...*):?} */
var ___em_js__node_path_resolve = Module["___em_js__node_path_resolve"] = createExportWrapper("__em_js__node_path_resolve");

/** @type {function(...*):?} */
var ___em_js__node_fs_existsSync = Module["___em_js__node_fs_existsSync"] = createExportWrapper("__em_js__node_fs_existsSync");

/** @type {function(...*):?} */
var ___em_js__node_fs_readFileSync = Module["___em_js__node_fs_readFileSync"] = createExportWrapper("__em_js__node_fs_readFileSync");

/** @type {function(...*):?} */
var ___em_js__node_fs_readFileSync_binary_hex = Module["___em_js__node_fs_readFileSync_binary_hex"] = createExportWrapper("__em_js__node_fs_readFileSync_binary_hex");
