...
var STACK_BASE = 5274368,
    STACKTOP = STACK_BASE,
    STACK_MAX = 31488,
    DYNAMIC_BASE = 5274368;
...
var ASM_CONSTS = {
  3695: function() {return process.platform == 'win32' ? 1 : 0},  
 3752: function() {return process.platform == 'darwin' ? 1 : 0},  
 3819: function() {return process.platform == 'linux' ? 1 : 0}
};
